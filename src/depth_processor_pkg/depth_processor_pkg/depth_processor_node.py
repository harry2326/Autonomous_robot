...
class DepthChecker(Node):
    ...
    def listener_callback(self, msg):
        ...
        # cv2.line(display_img, (col_split, row_split), (col_split, 2*row_split -30), (255, 0, 0), 2)
        # cv2.line(display_img, (2*col_split, row_split), (2*col_split, 2*row_split - 30), (255, 0, 0), 2)
        ...
        avg_msg.data = [float(avg_left), float(avg_middle), float(avg_right)]
